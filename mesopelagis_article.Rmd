...
lapply(perm.vector, make_prm, headerfile= "GOM_PRM_2015_header.prm", footerfile = "GOM_PRM_2015_footer.prm", beta.data= "beta_data.csv", beta.name.frame="beta_name_frame.csv", ad.adult.prey.data = "ad_adult_prey_data.csv", juv.prey.data= "juv_prey_data.csv", prey.frame.names = "prey_frame_names.csv")
